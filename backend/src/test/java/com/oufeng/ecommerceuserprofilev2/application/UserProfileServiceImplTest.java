...
class UserProfileServiceImplTest {
    ...
    void shouldReturnOverview() {
        ProfileOverviewResponse expected = new ProfileOverviewResponse(
                10000L, 8500L, 1200L, new BigDecimal("1250000.00"));
    ...
    void shouldReturnTagDistribution() {
        List<TagDistributionResponse> expected = List.of(
                new TagDistributionResponse("RFM_SEGMENT", "HIGH_VALUE", 1200L, new BigDecimal("0.1200"))
        );
    ...
    void shouldListProfiles() {
        ...
        when(queryMapper.queryProfiles(null, null, 0L, 20L)).thenReturn(records);
        when(queryMapper.countProfiles(null, null)).thenReturn(2L);

        Page<UserProfileListItemResponse> result = service.listProfiles(null, null, 0, 20);
    ...
    void shouldGetUserProfile() {
        ...
        assertThat(result.userCode()).isEqualTo("U001");
        assertThat(result.totalOrderCount()).isEqualTo(15);
    }
