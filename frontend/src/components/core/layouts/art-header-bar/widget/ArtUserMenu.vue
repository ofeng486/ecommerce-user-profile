    ...
    <template #default>
      <div class="pt-3">
        ...
        <ul class="py-4 mt-3 border-t border-g-300/80">
          ...
          <li class="btn-item btn-item-weak" @click="goPage('/public/dashboard')">
            <ArtSvgIcon icon="ri:tv-2-line" />
            <span>查看公开大屏</span>
          </li>
...
<style scoped>
  ...
  @layer components {
    ...
    .btn-item-weak {
      span { color: var(--art-gray-400); }
      .art-svg-icon { color: var(--art-gray-400); }
      &:hover span { color: var(--art-gray-600); }
      &:hover .art-svg-icon { color: var(--art-gray-600); }
    }
  }
