...
export const useUserStore = defineStore(
  ...
  () => {
     ...
     */
    const setToken = (token: string, newRefreshToken?: string) => {
    ...
    const logOut = () => {
      ...
      const redirect = currentRoute.path !== '/' ? currentRoute.fullPath : undefined
      router.push({
        path: '/',
        query: redirect ? { login: 'true', redirect } : undefined
      })
    }
